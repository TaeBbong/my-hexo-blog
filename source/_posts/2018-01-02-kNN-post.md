...
![kNN Result](https://taebbong.github.io/assets/img/knn_1.png){:width="500" height="200"}
...
![ValidTest Result](https://taebbong.github.io/assets/img/knn_2.png){:width="500" height="100"}
...
![scikit-knn](https://taebbong.github.io/assets/img/knn_3.png){:width="500" height="100"}
...
* 기계학습의 기초 포스팅은 다음 도서를 교재로 사용하고,
  ![Machine Learning in Action](https://taebbong.github.io/assets/img/knn_4.png){:width="50" height="100"}
